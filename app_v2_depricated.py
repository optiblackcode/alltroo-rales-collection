...
class AlltrooRallyExtractor:
    ...
    def extract_from_html(self, html_content: str) -> bool:
        """Parse HTML and extract rallies from rf-archiveList structure"""
        try:
            soup = BeautifulSoup(html_content, 'html.parser')
            self.rallies = []
            
            # Find all rally item wrappers
            item_wrappers = soup.find_all('div', class_='rf-archiveList__itemWrapper')
